...
public class PlayMode1Movement : InputTestFixture
{
    ...
    // Teste que simula a movimenta��o pressionando a tecla W
    [UnityTest]
    public IEnumerator PlayModeTestMoveUp()
    {
        ...
        Press(keyboard.wKey);
        yield return new WaitForSeconds(2f); // Espera um segundo para aplicar a movimenta��o
    ...
    // Teste que simula a movimenta��o pressionando a tecla S
    [UnityTest]
    public IEnumerator PlayModeTestMoveDown()
    {
        ...
        // Simula o pressionamento da tecla W
        Press(keyboard.sKey);
        yield return new WaitForSeconds(1f); // Espera um segundo para aplicar a movimenta��o
